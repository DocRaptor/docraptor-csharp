...
${nuget_cmd} install src/DocRaptor/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/DocRaptor.dll"
...
then
  ...
  echo "[INFO] bin/DocRaptor.dll was created successfully"
fi
