...
namespace DocRaptor.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AsyncDocStatus :  IEquatable<AsyncDocStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public AsyncDocStatus(string status = default(string), string downloadUrl = default(string), string downloadId = default(string), string message = default(string), int? numberOfPages = default(int?), string validationErrors = default(string))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as AsyncDocStatus);
        }

        /// <summary>
        /// Returns true if AsyncDocStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of AsyncDocStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AsyncDocStatus input)
        {
            if (input == null)
                return false;
